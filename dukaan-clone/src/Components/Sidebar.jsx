...
export const Sidebar = () => {
    return (
        <div>
            <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type='button' className="inline-flex items-center" >
            ...
            <aside id="default-sidebar" className="fixed text-white-200 top-0 left-0 z-40 w-56 h-screen transition-transform -translate-x-full sm:translate-x-0 " aria-label="Sidebar">
                    <div className="h-full px-3 py-4 overflow-y-auto bg-blue-800 flex flex-col gap-6">
                        <div>
                            <div className="flex items-center gap-3">
                                <div>
                                    <img src= { avatar } className="rounded h-10" alt="" />
                                </div>
                                <div>
                                    <div>
                                        <p className="h-3.8 leading-5.5 text-white-500 font-inter font-medium">Stavya</p>
                    ...
                    <ul className='space y-2 font-medium'>
                        ...
                        <li><a href="#" className="flex items-center p-2 rounded-lg dark:text-white hover:bg-white-100 hover:text-white-500 group">
                ...
                <div className="mt-auto">
                    <a href="#" className="flex items-center gap-2.5 p-2 rounded-lg bg-grey-100 hover:bg-white-100 hover:text-white-500 group ">
                        ...
                        <div>
                            <p className="text-xs font-normal">Available Credit</p>
                            <p className="text-base font-medium">372.2</p>
                        </div>
                    </a>
                </div>
