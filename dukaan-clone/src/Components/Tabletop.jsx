...
export const Tabletop = () => {
    return (
        <div className="flex items-center justify-between">
            <div className="bg-black-200 w-96 h-10 flex items-center">
                ...
                <form action="" className="w-full">
                    <input type="text" placeholder="Order ID or Transaction ID" className="bg-inherit w-full text-base focus:outline-none border-none pl" />
                </form>
            </div>
