    ...
    return (
        <div className='bg-white-500 px-3 pt-3 pb-2 rounded-lg grid gap-4'>
            ...
            <div className='relative overflow-x-auto'>
                <table className='w-full text-sm font-medium rounded uppercase text-black-400'>
                        ...
                        return (
                            <tbody>
                                <tr className='bg-white border-b'>
                                    <th scope='row' className='px-4 py-4 font-medium text-blue-700 whitespace-nowrap'>#{order.id}</th>
                                    <td className='px-4 py-4 flex items-center gap-2 text-black-600'>
